...
var APIError$1 = class APIError$1 extends OpenAIError {
...
var startsWithSchemeRegexp$1 = /^[a-z][a-z0-9+.-]*:/i;
...
var normalizePlatform$1 = (platform) => {
...
var cachedLoggers$1 = /* @__PURE__ */ new WeakMap();
			...
			try {
				for await (const sse of _iterSSEMessages$1(response, controller)) {
					...
					if (sse.event === null || !sse.event.startsWith("thread.")) {
						...
						if (data && data.error) throw new APIError$1(void 0, data.error, void 0, response.headers);
						...
						if (sse.event == "error") throw new APIError$1(void 0, data.error, data.message, void 0);
						yield {
							event: sse.event,
							data
						};
...
async function defaultParseResponse$1(client, props) {
	...
	const body = await (async () => {
		if (props.options.stream) {
			...
			return Stream$1.fromSSEResponse(response, props.controller, client, props.options.__synthesizeEventData);
		}
...
var CursorPage = class extends AbstractPage$1 {
	constructor(client, response, body, options) {
		super(client, response, body, options);
		this.data = body.data || [];
...
var ConversationCursorPage = class extends AbstractPage$1 {
	constructor(client, response, body, options) {
		super(client, response, body, options);
		this.data = body.data || [];
		this.has_more = body.has_more || false;
...
const maybeMultipartFormRequestOptions = async (opts, fetch) => {
	...
	return {
		...opts,
		body: await createForm$1(opts.body, fetch)
	};
};
...
var supportsFormDataMap$1 = /* @__PURE__ */ new WeakMap();
/**
...
var isNamedBlob$1 = (value) => value instanceof Blob && "name" in value;
var isUploadable = (value) => typeof value === "object" && value !== null && (value instanceof Response || isAsyncIterable$1(value) || isNamedBlob$1(value));
...
var addFormValue$1 = async (form, key, value) => {
	...
	else if (value instanceof Response) form.append(key, makeFile$1([await value.blob()], getName$1(value)));
	else if (isAsyncIterable$1(value)) form.append(key, makeFile$1([await new Response(ReadableStreamFrom$1(value)).blob()], getName$1(value)));
	else if (isNamedBlob$1(value)) form.append(key, value, getName$1(value));
	else if (Array.isArray(value)) await Promise.all(value.map((entry) => addFormValue$1(form, key + "[]", entry)));
	else if (typeof value === "object") await Promise.all(Object.entries(value).map(([name, prop]) => addFormValue$1(form, `${key}[${name}]`, prop)));
...
*/
var isBlobLike$1 = (value) => value != null && typeof value === "object" && typeof value.size === "number" && typeof value.type === "string" && typeof value.text === "function" && typeof value.slice === "function" && typeof value.arrayBuffer === "function";
/**
* This check adds the arrayBuffer() method type because it is available and used at runtime
*/
var isFileLike$1 = (value) => value != null && typeof value === "object" && typeof value.name === "string" && typeof value.lastModified === "number" && isBlobLike$1(value);
var isResponseLike$1 = (value) => value != null && typeof value === "object" && typeof value.url === "string" && typeof value.blob === "function";
/**
...
async function toFile$1(value, name, options) {
	...
	if (isFileLike$1(value)) {
		...
		return makeFile$1([await value.arrayBuffer()], value.name);
	}
...
var EMPTY$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.create(null));
...
*/
const path$2 = /* @__PURE__ */ createPathTagFunction$1(encodeURIPath$1);
/**
...
var EventStream = class {
	constructor() {
		...
		__classPrivateFieldSet$1(this, _EventStream_connectedPromise, new Promise((resolve, reject) => {
			__classPrivateFieldSet$1(this, _EventStream_resolveConnectedPromise, resolve, "f");
			__classPrivateFieldSet$1(this, _EventStream_rejectConnectedPromise, reject, "f");
		}), "f");
		__classPrivateFieldSet$1(this, _EventStream_endPromise, new Promise((resolve, reject) => {
			__classPrivateFieldSet$1(this, _EventStream_resolveEndPromise, resolve, "f");
	...
	*/
	on(event, listener) {
		(__classPrivateFieldGet$1(this, _EventStream_listeners, "f")[event] || (__classPrivateFieldGet$1(this, _EventStream_listeners, "f")[event] = [])).push({ listener });
		return this;
	}
	/**
	...
	*/
	once(event, listener) {
		(__classPrivateFieldGet$1(this, _EventStream_listeners, "f")[event] || (__classPrivateFieldGet$1(this, _EventStream_listeners, "f")[event] = [])).push({
			listener,
			once: true
		});
		return this;
	...
	*/
	emitted(event) {
		return new Promise((resolve, reject) => {
			__classPrivateFieldSet$1(this, _EventStream_catchingPromiseCreated, true, "f");
	...
	_emit(event, ...args) {
		if (__classPrivateFieldGet$1(this, _EventStream_ended, "f")) return;
		if (event === "end") {
			__classPrivateFieldSet$1(this, _EventStream_ended, true, "f");
		...
		if (event === "abort") {
			const error = args[0];
			if (!__classPrivateFieldGet$1(this, _EventStream_catchingPromiseCreated, "f") && !listeners?.length) Promise.reject(error);
			__classPrivateFieldGet$1(this, _EventStream_rejectConnectedPromise, "f").call(this, error);
			__classPrivateFieldGet$1(this, _EventStream_rejectEndPromise, "f").call(this, error);
			this._emit("end");
			return;
		}
		if (event === "error") {
...
_EventStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_endPromise = /* @__PURE__ */ new WeakMap(), _EventStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _EventStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _EventStream_listeners = /* @__PURE__ */ new WeakMap(), _EventStream_ended = /* @__PURE__ */ new WeakMap(), _EventStream_errored = /* @__PURE__ */ new WeakMap(), _EventStream_aborted = /* @__PURE__ */ new WeakMap(), _EventStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _EventStream_instances = /* @__PURE__ */ new WeakSet(), _EventStream_handleError = function _EventStream_handleError(error) {
	__classPrivateFieldSet$1(this, _EventStream_errored, true, "f");
	if (error instanceof Error && error.name === "AbortError") error = new APIUserAbortError$1();
	if (error instanceof APIUserAbortError$1) {
		__classPrivateFieldSet$1(this, _EventStream_aborted, true, "f");
...
var AbstractChatCompletionRunner = class extends EventStream {
	...
	*/
	...
	_emitFinal() {
		...
		if (this._chatCompletions.some((c) => c.usage)) this._emit("totalUsage", __classPrivateFieldGet$1(this, _AbstractChatCompletionRunner_instances, "m", _AbstractChatCompletionRunner_calculateTotalUsage).call(this));
	}
...
var partialParse$1 = (input) => parseJSON(input, Allow.ALL ^ Allow.NUM);
	...
	*/
	...
	[(_ChatCompletionStream_params = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_choiceEventStates = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_currentChatCompletionSnapshot = /* @__PURE__ */ new WeakMap(), _ChatCompletionStream_instances = /* @__PURE__ */ new WeakSet(), _ChatCompletionStream_beginRequest = function _ChatCompletionStream_beginRequest() {
		...
		if (toolCallSnapshot.type === "function") {
			const inputTool = __classPrivateFieldGet$1(this, _ChatCompletionStream_params, "f")?.tools?.find((tool) => isChatCompletionFunctionTool(tool) && tool.function.name === toolCallSnapshot.function.name);
		...
		for (const { delta, finish_reason, index, logprobs = null, ...other } of chunk.choices) {
			...
			if (content) {
				...
				if (!choice.message.refusal && __classPrivateFieldGet$1(this, _ChatCompletionStream_instances, "m", _ChatCompletionStream_getAutoParseableResponseFormat).call(this)) choice.message.parsed = partialParse$1(choice.message.content);
			}
			if (tool_calls) {
				...
				for (const { index, id, type, function: fn, ...rest } of tool_calls) {
					...
					if (fn?.arguments) {
						...
						if (shouldParseToolCall(__classPrivateFieldGet$1(this, _ChatCompletionStream_params, "f"), tool_call)) tool_call.function.parsed_arguments = partialParse$1(tool_call.function.arguments);
					}
				}
			}
		}
...
var Completions$2 = class extends APIResource$1 {
	...
	*/
	retrieve(completionID, options) {
		return this._client.get(path$2`/chat/completions/${completionID}`, options);
	}
	/**
	...
	*/
	delete(completionID, options) {
		return this._client.delete(path$2`/chat/completions/${completionID}`, options);
	}
	parse(body, options) {
...
Completions$2.Messages = Messages$3;
var Chat = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
var brand_privateNullableHeaders$1 = /* @__PURE__ */ Symbol("brand.privateNullableHeaders");
...
*/
var Speech = class extends APIResource$1 {
	/**
	...
	*/
	create(body, options) {
		return this._client.post("/audio/speech", {
			body,
			...options,
			headers: buildHeaders$1([{ Accept: "application/octet-stream" }, options?.headers]),
...
* Turn audio into text or text into audio.
*/
var Transcriptions = class extends APIResource$1 {
	create(body, options) {
		return this._client.post("/audio/transcriptions", multipartFormRequestOptions$1({
			body,
			...options,
			stream: body.stream ?? false,
...
* Turn audio into text or text into audio.
*/
var Translations = class extends APIResource$1 {
	create(body, options) {
		return this._client.post("/audio/translations", multipartFormRequestOptions$1({
			body,
			...options,
			__metadata: { model: body.model }
		}, this._client));
...
var Audio = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
var Batches$2 = class extends APIResource$1 {
	...
	*/
	retrieve(batchID, options) {
		return this._client.get(path$2`/batches/${batchID}`, options);
	}
	/**
	...
	*/
	cancel(batchID, options) {
		return this._client.post(path$2`/batches/${batchID}/cancel`, options);
	}
};
/**
* Build Assistants that can call models and use tools.
*/
var Assistants = class extends APIResource$1 {
	/**
	...
	*/
	create(body, options) {
		return this._client.post("/assistants", {
			body,
			...options,
			headers: buildHeaders$1([{ "OpenAI-Beta": "assistants=v2" }, options?.headers])
		});
	}
	/**
...
var Sessions$1 = class extends APIResource$1 {
	/**
...
var TranscriptionSessions = class extends APIResource$1 {
	/**
	* Create an ephemeral API token for use in client-side applications with the
...
*/
var Realtime$1 = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
var Sessions = class extends APIResource$1 {
	/**
	...
	*/
	create(body, options) {
		return this._client.post("/chatkit/sessions", {
			body,
			...options,
			headers: buildHeaders$1([{ "OpenAI-Beta": "chatkit_beta=v1" }, options?.headers])
		});
	}
	/**
...
var Threads$1 = class extends APIResource$1 {
	/**
...
var ChatKit = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
* @deprecated The Assistants API is deprecated in favor of the Responses API
*/
var Steps = class extends APIResource$1 {
	/**
...
var AssistantStream = class extends EventStream {
	...
	async _fromReadableStream(readableStream, options) {
		...
		this._connected();
		const stream = Stream$1.fromReadableStream(readableStream, this.controller);
		for await (const event of stream) __classPrivateFieldGet$1(this, _AssistantStream_instances, "m", _AssistantStream_addEvent).call(this, event);
		if (stream.controller.signal?.aborted) throw new APIUserAbortError$1();
...
* @deprecated The Assistants API is deprecated in favor of the Responses API
*/
var Runs$1 = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	async poll(runId, params, options) {
		const headers = buildHeaders$1([options?.headers, {
...
* @deprecated The Assistants API is deprecated in favor of the Responses API
*/
var Threads = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
Beta$1.Realtime = Realtime$1;
Beta$1.ChatKit = ChatKit;
Beta$1.Assistants = Assistants;
Beta$1.Threads = Threads;
/**
* Given a prompt, the model will return one or more predicted completions, and can also return the probabilities of alternative tokens at each position.
*/
var Completions$1 = class extends APIResource$1 {
	create(body, options) {
...
var Content$2 = class extends APIResource$1 {
	/**
...
var Files$3 = class extends APIResource$1 {
	...
	*/
	retrieve(fileID, params, options) {
		const { container_id } = params;
		return this._client.get(path$2`/containers/${container_id}/files/${fileID}`, options);
	}
	/**
	...
	*/
	delete(fileID, params, options) {
		...
		return this._client.delete(path$2`/containers/${container_id}/files/${fileID}`, {
			...options,
			headers: buildHeaders$1([{ Accept: "*/*" }, options?.headers])
		});
	}
};
Files$3.Content = Content$2;
var Containers = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	retrieve(containerID, options) {
		return this._client.get(path$2`/containers/${containerID}`, options);
	}
	/**
	* List Containers
	*/
...
*/
var Items = class extends APIResource$1 {
	/**
	...
	*/
	delete(itemID, params, options) {
		...
		return this._client.delete(path$2`/conversations/${conversation_id}/items/${itemID}`, options);
	}
};
/**
* Manage conversations and conversation items.
*/
var Conversations = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	retrieve(conversationID, options) {
		return this._client.get(path$2`/conversations/${conversationID}`, options);
	}
	/**
	...
	*/
	delete(conversationID, options) {
		return this._client.delete(path$2`/conversations/${conversationID}`, options);
	}
};
...
*/
var Embeddings = class extends APIResource$1 {
	/**
	...
	*/
	create(body, options) {
		...
		if (hasUserProvidedEncodingFormat) loggerFor$1(this._client).debug("embeddings/user defined encoding_format:", body.encoding_format);
		...
		loggerFor$1(this._client).debug("embeddings/decoding base64 embeddings from base64");
...
*/
var OutputItems = class extends APIResource$1 {
	/**
	* Get an evaluation run output item by ID.
	*/
	retrieve(outputItemID, params, options) {
		const { eval_id, run_id } = params;
		return this._client.get(path$2`/evals/${eval_id}/runs/${run_id}/output_items/${outputItemID}`, options);
	}
	/**
...
* Manage and run evals in the OpenAI platform.
*/
var Runs = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	retrieve(runID, params, options) {
		...
		return this._client.get(path$2`/evals/${eval_id}/runs/${runID}`, options);
	}
	/**
	...
	*/
	delete(runID, params, options) {
		const { eval_id } = params;
		return this._client.delete(path$2`/evals/${eval_id}/runs/${runID}`, options);
	}
	/**
	...
	*/
	cancel(runID, params, options) {
		const { eval_id } = params;
		return this._client.post(path$2`/evals/${eval_id}/runs/${runID}`, options);
	}
};
...
* Manage and run evals in the OpenAI platform.
*/
var Evals = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	retrieve(evalID, options) {
		return this._client.get(path$2`/evals/${evalID}`, options);
	}
	/**
	...
	*/
	delete(evalID, options) {
		return this._client.delete(path$2`/evals/${evalID}`, options);
	}
};
Evals.Runs = Runs;
/**
...
*/
var Files$2 = class extends APIResource$1 {
	/**
	...
	*/
	create(body, options) {
		return this._client.post("/files", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	...
	*/
	retrieve(fileID, options) {
		return this._client.get(path$2`/files/${fileID}`, options);
	}
	/**
	...
	*/
	delete(fileID, options) {
		return this._client.delete(path$2`/files/${fileID}`, options);
	}
	/**
...
var Methods = class extends APIResource$1 {};
/**
* Manage fine-tuning jobs to tailor a model to your specific training data.
*/
var Graders$1 = class extends APIResource$1 {
	/**
	* Run a grader.
	*
	* @example
...
var Alpha = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
* Manage fine-tuning jobs to tailor a model to your specific training data.
*/
var Permissions = class extends APIResource$1 {
	/**
	...
	*/
	create(fineTunedModelCheckpoint, body, options) {
		return this._client.getAPIList(path$2`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, Page$1, {
			body,
			method: "post",
			...options
		});
	...
	*/
	delete(permissionID, params, options) {
		...
		return this._client.delete(path$2`/fine_tuning/checkpoints/${fine_tuned_model_checkpoint}/permissions/${permissionID}`, options);
	}
};
var Checkpoints$1 = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
* Manage fine-tuning jobs to tailor a model to your specific training data.
*/
var Checkpoints = class extends APIResource$1 {
	/**
...
* Manage fine-tuning jobs to tailor a model to your specific training data.
*/
var Jobs = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	retrieve(fineTuningJobID, options) {
		return this._client.get(path$2`/fine_tuning/jobs/${fineTuningJobID}`, options);
	}
	/**
	...
	*/
	cancel(fineTuningJobID, options) {
		return this._client.post(path$2`/fine_tuning/jobs/${fineTuningJobID}/cancel`, options);
	}
	/**
	...
	*/
	pause(fineTuningJobID, options) {
		return this._client.post(path$2`/fine_tuning/jobs/${fineTuningJobID}/pause`, options);
	}
	/**
	...
	*/
	resume(fineTuningJobID, options) {
		return this._client.post(path$2`/fine_tuning/jobs/${fineTuningJobID}/resume`, options);
	}
};
Jobs.Checkpoints = Checkpoints;
var FineTuning = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
var GraderModels = class extends APIResource$1 {};
var Graders = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
*/
var Images = class extends APIResource$1 {
	/**
	...
	*/
	createVariation(body, options) {
		return this._client.post("/images/variations", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	edit(body, options) {
		return this._client.post("/images/edits", multipartFormRequestOptions$1({
			body,
			...options,
			stream: body.stream ?? false
		}, this._client));
...
var Models$2 = class extends APIResource$1 {
	...
	*/
	retrieve(model, options) {
		return this._client.get(path$2`/models/${model}`, options);
	}
	/**
	...
	*/
	delete(model, options) {
		return this._client.delete(path$2`/models/${model}`, options);
	}
};
/**
* Given text and/or image inputs, classifies if those inputs are potentially harmful.
*/
var Moderations = class extends APIResource$1 {
	/**
...
var Calls = class extends APIResource$1 {
	/**
...
var ClientSecrets = class extends APIResource$1 {
	/**
...
var Realtime = class extends APIResource$1 {
	constructor() {
		super(...arguments);
...
var ResponseStream = class ResponseStream extends EventStream {
	constructor(params) {
		...
		__classPrivateFieldSet$1(this, _ResponseStream_params, params, "f");
	}
	...
	async _createOrRetrieveResponse(client, params, options) {
		...
		this._connected();
		for await (const event of stream) __classPrivateFieldGet$1(this, _ResponseStream_instances, "m", _ResponseStream_addEvent).call(this, event, starting_after);
		if (stream.controller.signal?.aborted) throw new APIUserAbortError$1();
	...
	[(_ResponseStream_params = /* @__PURE__ */ new WeakMap(), _ResponseStream_currentResponseSnapshot = /* @__PURE__ */ new WeakMap(), _ResponseStream_finalResponse = /* @__PURE__ */ new WeakMap(), _ResponseStream_instances = /* @__PURE__ */ new WeakSet(), _ResponseStream_beginRequest = function _ResponseStream_beginRequest() {
		if (this.ended) return;
		__classPrivateFieldSet$1(this, _ResponseStream_currentResponseSnapshot, void 0, "f");
	}, _ResponseStream_addEvent = function _ResponseStream_addEvent(event, starting_after) {
		if (this.ended) return;
		const maybeEmit = (name, event) => {
			if (starting_after == null || event.sequence_number > starting_after) this._emit(name, event);
		};
		const response = __classPrivateFieldGet$1(this, _ResponseStream_instances, "m", _ResponseStream_accumulateResponse).call(this, event);
		...
		__classPrivateFieldSet$1(this, _ResponseStream_finalResponse, parsedResponse, "f");
		...
		if (!snapshot) {
			...
			snapshot = __classPrivateFieldSet$1(this, _ResponseStream_currentResponseSnapshot, event.response, "f");
			return snapshot;
		}
		switch (event.type) {
			...
			case "response.completed":
				__classPrivateFieldSet$1(this, _ResponseStream_currentResponseSnapshot, event.response, "f");
				break;
		}
		return snapshot;
	}, Symbol.asyncIterator)]() {
	...
	*/
	async finalResponse() {
		await this.done();
		const response = __classPrivateFieldGet$1(this, _ResponseStream_finalResponse, "f");
...
var InputItems = class extends APIResource$1 {
	/**
...
var InputTokens = class extends APIResource$1 {
	/**
...
var Responses = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	cancel(responseID, options) {
		return this._client.post(path$2`/responses/${responseID}/cancel`, options);
	}
	/**
...
var Content$1 = class extends APIResource$1 {
	/**
...
var Content = class extends APIResource$1 {
	/**
...
var Versions$1 = class extends APIResource$1 {
	...
	*/
	retrieve(version, params, options) {
		const { skill_id } = params;
		return this._client.get(path$2`/skills/${skill_id}/versions/${version}`, options);
	}
	/**
	...
	*/
	delete(version, params, options) {
		const { skill_id } = params;
		return this._client.delete(path$2`/skills/${skill_id}/versions/${version}`, options);
	}
};
Versions$1.Content = Content;
var Skills$1 = class extends APIResource$1 {
	...
	*/
	retrieve(skillID, options) {
		return this._client.get(path$2`/skills/${skillID}`, options);
	}
	/**
	...
	*/
	delete(skillID, options) {
		return this._client.delete(path$2`/skills/${skillID}`, options);
	}
};
Skills$1.Content = Content$1;
Skills$1.Versions = Versions$1;
/**
* Use Uploads to upload large files in multiple parts.
*/
var Parts = class extends APIResource$1 {
	/**
	* Adds a
	...
	*/
	create(uploadID, body, options) {
		return this._client.post(path$2`/uploads/${uploadID}/parts`, multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
...
* Use Uploads to upload large files in multiple parts.
*/
var Uploads = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	cancel(uploadID, options) {
		return this._client.post(path$2`/uploads/${uploadID}/cancel`, options);
	}
	/**
	* Completes the
...
var FileBatches = class extends APIResource$1 {
	/**
...
var Files$1 = class extends APIResource$1 {
	/**
	...
	*/
	content(fileID, params, options) {
		const { vector_store_id } = params;
		return this._client.getAPIList(path$2`/vector_stores/${vector_store_id}/files/${fileID}/content`, Page$1, {
			...options,
			headers: buildHeaders$1([{ "OpenAI-Beta": "assistants=v2" }, options?.headers])
		});
	}
};
var VectorStores = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	search(vectorStoreID, body, options) {
		return this._client.getAPIList(path$2`/vector_stores/${vectorStoreID}/search`, Page$1, {
			body,
			method: "post",
			...options,
			headers: buildHeaders$1([{ "OpenAI-Beta": "assistants=v2" }, options?.headers])
...
var Videos = class extends APIResource$1 {
	/**
	* Create a new video generation job from a prompt and optional reference assets.
	*/
	create(body, options) {
		return this._client.post("/videos", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	...
	*/
	retrieve(videoID, options) {
		return this._client.get(path$2`/videos/${videoID}`, options);
	}
	/**
	...
	*/
	delete(videoID, options) {
		return this._client.delete(path$2`/videos/${videoID}`, options);
	}
	/**
	* Create a character from an uploaded video.
	*/
	createCharacter(body, options) {
		return this._client.post("/videos/characters", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	...
	*/
	edit(body, options) {
		return this._client.post("/videos/edits", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	...
	*/
	extend(body, options) {
		return this._client.post("/videos/extensions", multipartFormRequestOptions$1({
			body,
			...options
		}, this._client));
	}
	...
	*/
	getCharacter(characterID, options) {
		return this._client.get(path$2`/videos/characters/${characterID}`, options);
	}
	/**
...
var Webhooks = class extends APIResource$1 {
	constructor() {
		super(...arguments);
	...
	*/
	async verifySignature(payload, headers, secret = this._client.webhookSecret, tolerance = 300) {
		...
		const headersObj = buildHeaders$1([headers]).values;
		...
		const timestamp = __classPrivateFieldGet$1(this, _Webhooks_instances, "m", _Webhooks_getRequiredHeader).call(this, headersObj, "webhook-timestamp");
...
var OpenAI = class {
	...
	*/
	constructor({ baseURL = readEnv$1("OPENAI_BASE_URL"), apiKey = readEnv$1("OPENAI_API_KEY"), organization = readEnv$1("OPENAI_ORG_ID") ?? null, project = readEnv$1("OPENAI_PROJECT_ID") ?? null, webhookSecret = readEnv$1("OPENAI_WEBHOOK_SECRET") ?? null, ...opts } = {}) {
		...
		*/
		...
		if (!options.dangerouslyAllowBrowser && isRunningInBrowser$1()) throw new OpenAIError("It looks like you're running in a browser-like environment.\n\nThis is disabled by default, as it risks exposing your secret API credentials to attackers.\nIf you understand the risks and have appropriate mitigations in place,\nyou can set the `dangerouslyAllowBrowser` option to `true`, e.g.,\n\nnew OpenAI({ apiKey, dangerouslyAllowBrowser: true });\n\nhttps://help.openai.com/en/articles/5112595-best-practices-for-api-key-safety\n");
		this.baseURL = options.baseURL;
		this.timeout = options.timeout ?? _a$1.DEFAULT_TIMEOUT;
		this.logger = options.logger ?? console;
		const defaultLogLevel = "warn";
		this.logLevel = defaultLogLevel;
		this.logLevel = parseLogLevel$1(options.logLevel, "ClientOptions.logLevel", this) ?? parseLogLevel$1(readEnv$1("OPENAI_LOG"), "process.env['OPENAI_LOG']", this) ?? defaultLogLevel;
		this.fetchOptions = options.fetchOptions;
		this.maxRetries = options.maxRetries ?? 2;
		this.fetch = options.fetch ?? getDefaultFetch$1();
		__classPrivateFieldSet$1(this, _OpenAI_encoder, FallbackEncoder$1, "f");
	...
	*/
	...
	async authHeaders(opts) {
		return buildHeaders$1([{ Authorization: `Bearer ${this.apiKey}` }]);
	}
	...
	*/
	...
	buildBody({ options: { body, headers: rawHeaders } }) {
		...
		else return __classPrivateFieldGet$1(this, _OpenAI_encoder, "f").call(this, {
			body,
			headers
		});
	}
};
_a$1 = OpenAI, _OpenAI_encoder = /* @__PURE__ */ new WeakMap(), _OpenAI_instances = /* @__PURE__ */ new WeakSet(), _OpenAI_baseURLOverridden = function _OpenAI_baseURLOverridden() {
...
*/
const SYSTEM_PROMPT = "Eres un asistente técnico en una reunión. Genera notas CONCISAS (máximo 3 líneas) sobre consultas técnicas. Responde SOLO con la nota, sin preámbulos ni explicaciones adicionales. Usa viñetas si hay más de un punto.";
function buildUserPrompt(query, context) {
	return `Contexto de la reunión: "${context}"\n\nConsulta detectada: "${query}"\n\nEscribe una nota técnica breve y útil.`;
}
var OllamaStrategy = class {
	ollama = null;
	currentHost = "";
	getClient(host) {
	...
	async generateNote(query, context, model, options) {
	...
	async listModels(options) {
		const { models } = await this.getClient(options.host).list();
...
var GeminiStrategy = class {
	...
	async generateNote(query, context, model, options) {
		const genModel = this.getClient(options.apiKey).getGenerativeModel({
			model,
			systemInstruction: SYSTEM_PROMPT
		});
		const userPrompt = buildUserPrompt(query, context);
		return (await genModel.generateContent(userPrompt)).response.text().trim();
	}
};
var OpenAIStrategy = class {
	openai = null;
	currentKey = "";
	getClient(apiKey) {
	...
	async generateNote(query, context, model, options) {
		...
		return (await client.chat.completions.create({
			...
			messages: [{
				role: "system",
				content: "Eres un asistente técnico en una reunión. Genera notas CONCISAS (máximo 3 líneas) sobre consultas técnicas. Responde SOLO con la nota, sin preámbulos ni explicaciones adicionales. Usa viñetas si hay más de un punto."
			}, {
				role: "user",
				content: userPrompt
			}],
...
function getAIStrategy(type) {
	...
	if (!strategy) throw new Error(`Strategy not found: ${type}`);
	return strategy;
}
var MAX_CONTEXT_CHARS = 1200;
var meetingContext = "";
function appendContext(text) {
	meetingContext = (meetingContext + " " + text).slice(-MAX_CONTEXT_CHARS).trim();
}
async function generateNote(query, provider, model, options) {
	return await getAIStrategy(provider).generateNote(query, meetingContext, model, options);
}
function setupLLMIPC(win) {
	ipcMain.handle("llm:generate-note", async (_e, query, provider, model, options) => {
		try {
	...
	ipcMain.handle("ollama:list-models", async (_e, host) => {
		try {
			...
			if ("listModels" in strategy && typeof strategy.listModels === "function") return {
				connected: true,
				models: await strategy.listModels({ host })
			};
			return {
				connected: false,
				models: [],
...
function float32ToWavBuffer(samples, sampleRate = 16e3) {
	const numChannels = 1;
...
async function transcribeOpenAI(audioData, language, apiKey) {
	...
	try {
		const result = await client.audio.transcriptions.create({
			file,
			model: "whisper-1",
			language: language === "auto" ? void 0 : language || void 0
		});
...
function setupTranscriberIPC(win) {
	...
	ipcMain.handle("transcribe:chunk", async (_e, buffer, source, language, transcriptionEngine, openaiApiKey, aiProvider, aiModel, aiOptions) => {
		const audioData = new Float32Array(buffer);
		let text = "";
		if (transcriptionEngine === "openai") text = await transcribeOpenAI(audioData, language, openaiApiKey);
		else text = await transcribeBuffer(audioData, language);
		if (!text) return {
			text: "",
			source,
		...
		if (detection.isTechnical) generateNote(text, aiProvider, aiModel, aiOptions).then((noteText) => {
...
var store = new Store({ defaults: DEFAULT_SETTINGS });
var win = null;
